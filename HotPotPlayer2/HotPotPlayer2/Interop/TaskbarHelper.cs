    ...
    public class TaskbarHelper(IntPtr handle)
    {
        ...
        public void InitTaskBarButtons()
        {
            if (_instance == null)
            {
                ...
                _buttons[0].iId = 0;
                _buttons[0].hIcon = (Windows.Win32.UI.WindowsAndMessaging.HICON)LoadImage(0, Path.Combine(path, "Assets/Icons/prev.ico"), IMAGE_ICON, 32, 32, LR_LOADFROMFILE);
                ...
                _buttons[1].iId = 1;
                _buttons[1].hIcon = (Windows.Win32.UI.WindowsAndMessaging.HICON)LoadImage(0, Path.Combine(path, "Assets/Icons/pause.ico"), IMAGE_ICON, 32, 32, LR_LOADFROMFILE);
                ...
                _buttons[2].iId = 2;
                _buttons[2].hIcon = (Windows.Win32.UI.WindowsAndMessaging.HICON)LoadImage(0, Path.Combine(path, "Assets/Icons/next.ico"), IMAGE_ICON, 32, 32, LR_LOADFROMFILE);
